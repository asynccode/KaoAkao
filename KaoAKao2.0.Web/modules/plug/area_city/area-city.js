...
define(function (require, exports, module) {
    require("plug/area_city/area-city.css")
    var $ = require("jquery"), Global = require("global"), Option = "<option value=''>请选择</option>";
    var Default = {
        elementID: "areaCity",
        dataUrl: "/Base/GetChildAreaByCode"
    };
    var AreaCity = function (options) {
        this.setting = [];
        this.init(options);
    };
    //初始化
    AreaCity.prototype.init = function (options) {
        ...
        _self.getChildren(_self.province, "0086");
    ...
    exports.createArea = function (options) {
        return new AreaCity(options);
    }
});